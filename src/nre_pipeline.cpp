...
void NrePipeline::enableAlphaBlending(PipelineConfigInfo &configInfo) {
  ...
  configInfo.colorBlendAttachment.colorBlendOp =
      VK_BLEND_OP_ADD; // these values are being added together
  configInfo.colorBlendAttachment.srcAlphaBlendFactor =
      VK_BLEND_FACTOR_ONE; // x
  configInfo.colorBlendAttachment.dstAlphaBlendFactor =
      VK_BLEND_FACTOR_ZERO;                                       // x
  configInfo.colorBlendAttachment.alphaBlendOp = VK_BLEND_OP_ADD; // x
  // fields marked x needed bc not checking distance at any point
}
